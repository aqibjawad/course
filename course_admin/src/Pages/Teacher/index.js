...
const Teacher = () => {
    ...
    const edit = async (event, id) => {
        GETID("teacher", id, "").then((result)=>{
            setTeacherId(result[0]);
        });
        handleShow();
    };
        ...
        <div className="main-body content-wrapper" style={{backgroundColor:"white"}} >
                                            ...
                                            <div className="row">
                                                <Col>
                                                    <Form.Group className="mb-3" controlId="formBasicEmail">
                                                        ...
                                                        <Form.Control ref={firstnameRef} type="text" placeholder="Enter Name" style={{background:"#E6E6E6"}}/>
                                                    </Form.Group>

                                                    <Form.Group className="mb-3" controlId="formBasicEmail">
                                                        <Form.Label style={{ fontFamily: "serif", fontWeight: "normal" }}> Last Name </Form.Label>
                                                        <Form.Control ref={lastnameRef} type="text" placeholder="Enter Name" style={{background:"#E6E6E6"}}/>
                                                    </Form.Group>

                                                    <Form.Group className="mb-3" controlId="formBasicEmail">
                                                        <Form.Label style={{ fontFamily: "serif", fontWeight: "normal" }}> Email </Form.Label>
                                                        <Form.Control ref={emailRef} type="email" placeholder="Enter Email" style={{background:"#E6E6E6"}}/>
                                                    </Form.Group>

                                                    <Form.Group className="mb-3" controlId="formBasicEmail">
                                                        <Form.Label style={{ fontFamily: "serif", fontWeight: "normal" }}> Password </Form.Label>
                                                        <Form.Control ref={passwordRef} type="password" placeholder="Enter Password" style={{background:"#E6E6E6"}} />
                                                    </Form.Group>
                                                </Col>
            ...
            <Modal show={show} onHide={handleClose}>
                ...
                <Modal.Body>
                    <Row className="">
                        <Col>
                            ...
                            <Form.Label style={{ fontFamily: "serif", fontWeight: "normal" }}> First Name </Form.Label>
                            <Form.Control ref={efirstnameRef} type="text"  style={{background:"#E6E6E6"}} placeholder={teacherid.firstname}/>
                        </Col>

                        <Col>
                            <Form.Label style={{ fontFamily: "serif", fontWeight: "normal" }}> Last Name </Form.Label>
                            <Form.Control ref={elastnameRef} type="text" placeholder={teacherid.lastname} style={{background:"#E6E6E6"}}/>
                        </Col>

                        <Col>
                            <Form.Label style={{ fontFamily: "serif", fontWeight: "normal" }}> Email </Form.Label>
                            <Form.Control ref={eemailRef} type="email" placeholder={teacherid.email} style={{background:"#E6E6E6"}}/>

                        </Col>

                        <Col>
                            <Form.Label style={{ fontFamily: "serif", fontWeight: "normal" }}> Password </Form.Label>
                            <Form.Control ref={epasswordRef} type="password" placeholder={teacherid.password} style={{background:"#E6E6E6"}} />
                        </Col>

                        <Col md={6}>

                            <Form.Label style={{ fontFamily: "serif", fontWeight: "normal" }}> Category </Form.Label>
                            <Form.Control ref={edepartmentRef} className="form-control" as="select" style={{background:"#E6E6E6"}} >
                                <option value="">  </option>
                                {departments.map((department) => (
                                    <option value={department.id}>{department.department}</option>
                                ))}
                ...
                <div className="my-2 pl-3 mb-5">
                    <Button className="btn-custom border-0 mx-3" variant="danger" onClick={(e) => eSubmit(e, teacherid)} style={{ fontFamily: "serif", fontWeight: "normal" ,background:"rgba(7,48,111,1)", borderColor:"rgba(7,48,111,1)"}}>
                        Modify
                    </Button>
                </div>
            </Modal>
