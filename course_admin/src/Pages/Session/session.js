...
const Session = () => {
    ...
    const edit = async (event, id) => {
        GETID("session", id, "").then((result)=>{
            setSessionId(result[0]);
        });
        handleShow();
    };
                                ...
                                <div className="row">
                                    ...
                                    <Col md={12}>
                                        <Form.Group className="">
                                            ...
                                            <Form.Control ref={sessionRef} type="text" placeholder="hint i.e; 2019" style={{background:"#E6E6E6"}}/>
                                        </Form.Group>
                                    </Col>
                    ...
                    <Row className="">
                        <Col md={6}>
                            ...
                            <Form.Control ref={edepartmentRef} className="form-control" as="select" style={{background:"#E6E6E6"}}>
                                <option placeholder={sessionid.department}>  </option>
                                {departments.map((department) => (
                                    <option value={department.id} >{department.department}</option>
                                ))}
                            </Form.Control>
                        ...
                        <Col md={6}>
                            ...
                            <FormControl ref={esessionRef} className="form-control" style={{background:"#E6E6E6"}} placeholder={sessionid.session}/>
                        </Col>
                    </Row>
                </Modal.Body>
                <div className="my-2 pl-3 mb-5">
                    <Button className="btn-custom border-0 mx-3" variant="danger" onClick={(e) => eSubmit(e, sessionid)} style={{ fontFamily: "serif", fontWeight: "normal" ,background:"rgba(7,48,111,1)", borderColor:"rgba(7,48,111,1)" }}>
                        Modify
                    </Button>
                </div>
            </Modal>
