            ...
            >
                <section class="content">
                    <div className="conatiner-fluid">
                        ...
                        <div className="conatiner-fluid">
                            <Row style={{ marginTop: "150px", padding: " 10px 10px", marginRight: "30px ", justifyItems: "center" }}>
                                <Col sm={4}>
                                    <Card className="mt-5" style={{ width: " 250px" }}>
                                        <div className="card-head7" style={{ background: "#087B50" }} >
                                ...
                                <Col sm={4}>
                                    <Card className="mt-5"style={{ width: " 250px" }}>
                                        <div className="card-head5" style={{ background: "#26A7A2" }}>
                        ...
                        <Container>
                            ...
                            <Col>
                                <img src={`${process.env.REACT_APP_MEDIA_URL}/assignment/${coursefiles.assignmentquestion,
                                    ...
                                    coursefiles.assignment_result}`} alt="Assinment"/>
                            </Col>
                            <Col>
                ...
                {active === 3 ? (
                    <div>
                        <Container>
                            ...
                            <Col>
                                <img src={`${process.env.REACT_APP_MEDIA_URL}/mid/${coursefiles.midquestion,
                                    coursefiles.mid_lowest, coursefiles.mid_average, coursefiles.mid_best, coursefiles.mid_result}`}
                                    alt="mid" />
