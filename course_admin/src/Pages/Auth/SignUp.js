...
const Signup = () => {
    ...
    return (
        ...
        >
            <Card className="border-0" style={{ width: "400px",backgroundColor: "white", alignItems:"center" }} >
                <Card.Body style={{ padding: "20px" }}>
                    <div className="container">
                        <img src={logo} alt="Logo" style={{ marginBottom: '5px',marginLeft:'104px', maxWidth: '130px', maxHeight: '75px', borderRadius: 50, display: "inline-block"  }} />
                    ...
                    <Form onSubmit={submit}>
                        ...
                        >
                            <Form.Control
                                ...
                                ref={firstnameRef}
                                required
                                style={{width: "350px", fontFamily: "serif", fontWeight: "normal",background:"#E6E6E6" }}
                            />
                        </Form.Group>
                        <Form.Group
                            className="mb-3"
            ...
            fontFamily: "serif", fontWeight: "normal" }}> Back To  
                    <Link
            to="/"
