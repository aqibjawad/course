...
const Semester = () => {
    ...
    return (
        <div>
            <p style={{ fontWeight: "bold", fontSize: "30px", marginBottom: "-3px", fontStyle: "normal", textAlign: "center", fontFamily: "serif" }}> Semester</p>
            <Row>
            ...
            <Modal show={show} onHide={handleClose}>
                ...
                <div className="my-2 pl-3 mb-5">
                    <Button className="btn-custom border-0 mx-3" variant="danger" onClick={(e) => eSubmit(e, semesterid)} style={{ fontFamily: "serif", fontWeight: "normal" }}>
                        Modify
                    </Button>
                </div>
            </Modal>
