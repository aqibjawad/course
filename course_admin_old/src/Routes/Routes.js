...
const routes =[
    ...
    {path:'/semester', element:< Semester />, exact:'true', type:'private' },

    {path:'/websiteuser', element:< WebsiteUser />, exact:'true', type:'private' },

    {path:'/course', element:< Coursefileadmin />, exact:'true', type:'private' },
