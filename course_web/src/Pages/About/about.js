...
export default function About() {
    return (
        <div className="main-body content-wrapper" style={{ backgroundColor: "white", marginLeft:"0px" }}>
            <div
                style={{
                            ...
                            <div className="container-fluid">
                                <div className="row mb-2">
                                    <div className="col-sm-6">
                                        <p className="m-0" style={{ fontWeight: "bold", fontSize: "30px", fontStyle: "normal", fontFamily: "serif" ,color:"black"}}>
                                            About US</p>
                                    </div>{/* /.col */}
